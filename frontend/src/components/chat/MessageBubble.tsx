...
import { ArrowDownTrayIcon, DocumentIcon, CheckIcon } from "@heroicons/react/24/outline";
...
export function MessageBubble({
  ...
  const needsBlob = message.type === "IMAGE" || message.type === "VOICE" || isVideo;
  ...
  return (
    <div className={clsx("flex", mine ? "justify-end" : "justify-start")}>
      ...
      >
        ...
        {message.type === "VOICE" && (blobUrl ? <audio controls src={blobUrl} className="h-10 w-56 max-w-full" /> : <p className="text-xs opacity-80">Loading voice message…</p>)}
